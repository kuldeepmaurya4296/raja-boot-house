  ...
  return (
    <form className="mt-6 flex flex-col sm:flex-row max-w-md mx-auto gap-2.5 relative" onSubmit={handleSubmit}>
      <input
        ...
        required
      />
      <button type="submit" className="bg-primary text-primary-foreground px-6 py-3.5 rounded-full text-xs font-semibold whitespace-nowrap hover:opacity-95 transition cursor-pointer w-full sm:w-auto">
        Subscribe
      </button>
    </form>
  );
