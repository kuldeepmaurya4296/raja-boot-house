                ...
                {activeTab === "chart" ? (
                  <div className="space-y-4">
                    <p className="text-xs text-muted-foreground font-medium">
                      All shoes in Raja Boot House follow the standard UK/India sizing convention. Use this table to convert your sizing to US or European formats.
                    </p>
                          ...
                          {sizeChartData.map((row) => (
                            <tr 
                              ...
                              className={`hover:bg-muted/30 transition-colors ${
                                selectedSize === row.uk ? "bg-primary/5 font-bold text-primary" : "text-muted-foreground"
                              }`}
                            >
                              <td className="px-4 py-3 font-bold text-charcoal flex items-center gap-1.5">
                                {row.uk}
                                {selectedSize === row.uk && (
                                  <span className="text-[9px] bg-primary text-primary-foreground px-1.5 py-0.5 rounded-full">Selected</span>
                                )}
                              </td>
                              ...
                              <td className="px-4 py-3 text-right font-medium text-charcoal">{row.lengthCm} cm</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="bg-muted/30 p-4 rounded-2xl flex items-center justify-center border border-border/40">
                      <svg viewBox="0 0 100 120" className="h-36 w-auto text-muted-foreground/30 fill-none stroke-current" strokeWidth="1.5">
                        ...
                        <line x1="50" y1="30" x2="55" y2="30" className="stroke-muted-foreground/30" />
                        <line x1="50" y1="50" x2="55" y2="50" className="stroke-muted-foreground/30" />
                        <line x1="50" y1="70" x2="55" y2="70" className="stroke-muted-foreground/30" />
                        <line x1="50" y1="90" x2="55" y2="90" className="stroke-muted-foreground/30" />
                      </svg>
                    </div>

                    {/* Right column: Instructions */}
                    <div className="space-y-4 text-xs text-muted-foreground">
                      <h4 className="font-bold text-sm text-charcoal uppercase tracking-wider mb-2">Measure Heel-To-Toe</h4>
                      <ol className="list-decimal list-inside space-y-2.5 leading-relaxed font-medium">
                        <li>
                          <span className="text-charcoal font-bold">Position your heel:</span> Stand up straight and place your heel against a flat wall.
                        </li>
                        <li>
                          <span className="text-charcoal font-bold">Mark length:</span> Place a sheet of paper flat on the floor underneath your foot, and draw a line at the longest toe.
                        </li>
                        <li>
                          <span className="text-charcoal font-bold">Measure distance:</span> Use a ruler to measure the distance from the wall/edge of the paper to the line in centimeters.
                        </li>
                        <li>
                          <span className="text-charcoal font-bold">Match on chart:</span> Reference the conversion chart tab to find your correct UK/India size!
                        </li>
                      </ol>
                      ...
                      <div className="bg-primary/5 p-3 rounded-xl border border-primary/10 mt-2">
                        <p className="font-semibold text-primary leading-relaxed">
                          💡 <span className="underline">Pro Tip</span>: Measure your feet in the afternoon since feet swell slightly during the day. If you are between sizes, we recommend ordering the larger size!
                        </p>
                      </div>
                    </div>
                  </div>
