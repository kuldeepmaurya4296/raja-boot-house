...
export function SalesChart({ 
  ...
  return (
    <div className="relative w-full h-[180px] select-none" onMouseLeave={() => setHoveredIndex(null)}>
      ...
      {hoveredIndex !== null && data[hoveredIndex] !== undefined && (
        ...
        >
          <div className="font-bold text-[9px] text-brass/70 uppercase tracking-wider">{labels[hoveredIndex]}</div>
      ...
      >
        ...
        {hoveredIndex !== null && points[hoveredIndex] && (
          <g>
            ...
            />
            <circle cx={points[hoveredIndex].x} cy={points[hoveredIndex].y} r="6.5" fill="#846358" opacity="0.25" />
            <circle cx={points[hoveredIndex].x} cy={points[hoveredIndex].y} r="3.5" fill="#846358" stroke="#fff" strokeWidth="1.5" />
          </g>
        )}
