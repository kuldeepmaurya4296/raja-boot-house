...
const cols: Column<any>[] = [
  { key: "n", header: "Vendor", sortKey: "name", render: v => <div><p className="font-medium text-sm">{v.name}</p><p className="text-xs text-muted-foreground">{v.email}</p></div> },
  ...
  { key: "s", header: "Status", sortKey: "status", render: v => <StatusBadge status={v.isActive ? "active" : "pending"} /> },
];
