...
export function ProductForm({ 
  ...
  const { register, control, handleSubmit, formState: { errors }, watch, setValue } = useForm<FormData>({
    ...
    defaultValues: {
      ...
      occasion: (initialData?.occasion && initialData.occasion.length > 0) ? initialData.occasion : ["Daily"],
      images: initialData?.images || [{ url: "", public_id: "placeholder" }],
      variants: initialData?.variants || [{ size: 7, color: "Black", colorHex: "#000000", stock: 10, sku: "", images: [] }],
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Link href="/admin/inventory/products" className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="bg-card border border-border rounded-xl p-6 shadow-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input {...register("name")} onChange={handleNameChange} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm" />
              {errors.name && <p className="text-red-500 text-xs mt-1">{errors.name.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Slug</label>
              <input {...register("slug")} onChange={handleSlugChange} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm" />
              {errors.slug && <p className="text-red-500 text-xs mt-1">{errors.slug.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Brand</label>
              <select {...register("brand")} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm">
            ...
            <div>
              ...
              <select {...register("category")} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm">
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
              ...
              <input type="number" {...register("price")} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm" />
              {errors.price && <p className="text-red-500 text-xs mt-1">{errors.price.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Sale Price</label>
              <input type="number" {...register("salePrice")} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm" />
            ...
            <div>
              ...
              <input type="number" {...register("returnDays")} min="0" className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm" />
              {errors.returnDays && <p className="text-red-500 text-xs mt-1">{errors.returnDays.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Gender</label>
              <select {...register("gender")} className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 text-sm">
            ...
            <div className="flex items-center gap-2 pt-6">
              <input type="checkbox" id="isActive" {...register("isActive")} className="h-4 w-4 rounded border-border text-primary focus:ring-primary" />
            ...
            <div className="md:col-span-5 border-t border-border/40 pt-4 mt-2">
              ...
              <div className="flex flex-wrap gap-4">
                {["Daily", "Wedding", "Bridal", "Party", "Function", "Sports"].map((occ) => (
                  <label key={occ} className="flex items-center gap-2 text-sm font-medium cursor-pointer">
                    <input
                      type="checkbox"
                      value={occ}
                      {...register("occasion")}
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-card">
          <div className="flex justify-between items-center mb-6">
            ...
            <button type="button" onClick={() => appendImage({ url: "", public_id: "placeholder" })} className="text-sm bg-muted hover:bg-muted/80 px-3 py-1.5 rounded-md flex items-center gap-1 font-medium transition-colors cursor-pointer">
          ...
          <div className="space-y-4">
            {imageFields.map((field, index) => (
              <div key={field.id} className="flex flex-col gap-1 border border-border/40 p-4 rounded-lg bg-muted/5 relative">
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-card">
          <div className="flex justify-between items-center mb-6">
            ...
            <button type="button" onClick={() => appendVariant({ size: 8, color: "Black", colorHex: "#000000", stock: 10, sku: "", images: [] })} className="text-sm bg-muted hover:bg-muted/80 px-3 py-1.5 rounded-md flex items-center gap-1 font-medium transition-colors cursor-pointer">
            ...
            {variantFields.map((field, index) => (
              <div key={field.id} className="grid grid-cols-5 gap-3 items-start border border-border/50 p-4 rounded-lg bg-muted/10 relative">
                <div>
                  ...
                  {errors.variants?.[index]?.size && <p className="text-red-500 text-[10px] mt-0.5">{errors.variants[index].size.message}</p>}
                </div>
                <div>
                  ...
                  {errors.variants?.[index]?.color && <p className="text-red-500 text-[10px] mt-0.5">{errors.variants[index].color.message}</p>}
                </div>
                <div>
                  ...
                  {errors.variants?.[index]?.colorHex && <p className="text-red-500 text-[10px] mt-0.5">{errors.variants[index].colorHex.message}</p>}
                </div>
                <div>
                ...
                <div className="col-span-5 mt-3 pt-3 border-t border-border/40">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide">Variant-Specific Images</span>
                    <button
                      type="button"
                      onClick={() => {
                        const currentImages = watch(`variants.${index}.images`) || [];
                        setValue(`variants.${index}.images`, [...currentImages, { url: "", public_id: `var-${index}-img-${currentImages.length}` }]);
                      }}
                  ...
                  <div className="space-y-2">
                    {(watch(`variants.${index}.images`) || []).map((imgField: any, imgIndex: number) => (
                      <div key={imgIndex} className="flex flex-col gap-1">
                        <div className="flex gap-2 items-center">
                              ...
                              render={({ field: uploaderField }) => (
                                <ImageUploader
                                  ...
                                  onChange={(val) => {
                                    ...
                                    if (!watch(`variants.${index}.images.${imgIndex}.public_id`)) {
                                      setValue(`variants.${index}.images.${imgIndex}.public_id`, `var-${index}-img-${imgIndex}`);
                                    }
                                  }}
                          ...
                          <button
                            ...
                            onClick={() => {
                              const currentImages = watch(`variants.${index}.images`) || [];
                              setValue(`variants.${index}.images`, currentImages.filter((_: any, i: number) => i !== imgIndex));
                            }}
                        ...
                        {errors.variants?.[index]?.images?.[imgIndex]?.url && (
                          <p className="text-red-500 text-[10px]">{errors.variants[index].images[imgIndex].url.message}</p>
                        )}
                      </div>
                    ))}
                  </div>
                ...
                {variantFields.length > 1 && (
                  <button type="button" onClick={() => removeVariant(index)} className="absolute -top-2 -right-2 p-1.5 bg-background border border-border shadow-sm text-destructive hover:bg-destructive hover:text-white rounded-full transition-colors cursor-pointer">
