...
export function CategoriesClient({ categories, totalItems = 0 }: { categories: CategoryData[], totalItems?: number }) {
  ...
  const cols: Column<CategoryData>[] = [
    ...
    { key: "count", header: "Products", sortKey: "productCount", render: c => <span className="text-sm">{c.productCount}</span> },
