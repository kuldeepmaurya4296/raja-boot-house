...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    try {
      const c = localStorage.getItem(KEY); if (c) setLines(JSON.parse(c));
  ...
  return <Ctx.Provider value={{ lines, wishlist, add, remove, setQty, clear, toggleWish, count, subtotal }}>{children}</Ctx.Provider>;
}
